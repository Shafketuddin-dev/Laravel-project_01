...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('t_c_s', function (Blueprint $table) {
            ...
            $table->longText('bn_payment_mode')->nullable();
            $table->longText('en_documentation')->nullable();
            $table->longText('bn_documentation')->nullable();
            $table->longText('en_after_sales_service')->nullable();
            $table->longText('bn_after_sales_service')->nullable();
            $table->longText('en_client_responsibility')->nullable();
            $table->longText('bn_client_responsibility')->nullable();
            $table->longText('en_others')->nullable();
            $table->longText('bn_others')->nullable();
            $table->longText('en_contact_termination')->nullable();
            $table->longText('bn_contact_termination')->nullable();
            $table->timestamps();
        });
    }
