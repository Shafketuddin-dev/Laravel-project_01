...
@section('title')
Admin :: Pending Search Result Online Registration
@endsection
@section('content')
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('pending_connection') }}" class="btn btn-success mb-3">
                    <i class="zmdi zmdi-replay"></i> Back to Pending Connection
                </a>
