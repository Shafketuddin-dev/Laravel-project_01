...
<div class="row">
    ...
    <div class="col-lg-12">
        <a class="btn btn-sm btn-success" href="{{ route('dashboard') }}"><i class="zmdi zmdi-replay"></i> Back to Dashboard</a>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    @endif
                                    <a href="{{ route('edit_admin', $user->id) }}" title="Edit Admin"><button class="btn btn-primary"><i class="zmdi zmdi-edit"></i>
                                    Admin</button></a>
