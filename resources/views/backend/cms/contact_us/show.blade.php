...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_contact_label') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Contact Label & Title
                </a>
                <form action="{{ route('admin.save_contact_label') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_name_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_name_label" type="text" id="en_name_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_name_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_name_label" type="text" id="bn_name_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_email_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_email_label" type="text" id="en_email_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_email_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_email_label" type="text" id="bn_email_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_phone_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_phone_label" type="text" id="en_phone_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_phone_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_phone_label" type="text" id="bn_phone_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_subject_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_subject_label" type="text" id="en_subject_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_subject_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_subject_label" type="text" id="bn_subject_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_message_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_message_label" type="text" id="en_message_label">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_message_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_message_label" type="text" id="bn_message_label">
