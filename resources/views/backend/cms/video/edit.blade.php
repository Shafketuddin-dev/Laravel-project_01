...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_video') }}" class="btn btn-sm btn-success">
                    Manage Video
                </a>
                <form action="{{ route('admin.update_video') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="video_id" value="{{$video->id}}">
                    <div class="row">
                        <div class="col-lg-4">
                            <img class="img-fluid" src="{{ asset($video->image)}}" alt="">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($video->en_title) ? $video->en_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($video->bn_title) ? $video->bn_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_date') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_date" type="text" id="en_date" value="{{ isset($video->en_date) ? $video->en_date : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_date') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_date" type="text" id="bn_date" value="{{ isset($video->bn_date) ? $video->bn_date : '' }}">
