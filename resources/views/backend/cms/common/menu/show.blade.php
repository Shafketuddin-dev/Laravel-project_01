...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_menu') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Menu
                </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_home') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_home" type="text" id="en_menu_home">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_home') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_home" type="text" id="bn_menu_home">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_whoweare_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_whoweare_title" type="text" id="en_menu_whoweare_title">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_whoweare_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_whoweare_title" type="text" id="bn_menu_whoweare_title">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_about_us') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_about_us" type="text" id="en_menu_about_us">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_about_us') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_about_us" type="text" id="bn_menu_about_us">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_branches') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_branches" type="text" id="en_menu_branches">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_branches') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_branches" type="text" id="bn_menu_branches">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_md_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_md_profile" type="text" id="en_menu_md_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_md_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_md_profile" type="text" id="bn_menu_md_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_md_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_md_message" type="text" id="en_menu_md_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_md_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_md_message" type="text" id="bn_menu_md_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_chairman_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_chairman_profile" type="text" id="en_menu_chairman_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_chairman_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_chairman_profile" type="text" id="bn_menu_chairman_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_chairman_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_chairman_message" type="text" id="en_menu_chairman_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_chairman_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_chairman_message" type="text" id="bn_menu_chairman_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_dmd_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_dmd_profile" type="text" id="en_menu_dmd_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_dmd_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_dmd_profile" type="text" id="bn_menu_dmd_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_dmd_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_dmd_message" type="text" id="en_menu_dmd_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_dmd_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_dmd_message" type="text" id="bn_menu_dmd_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_ed_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_ed_profile" type="text" id="en_menu_ed_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_ed_profile') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_ed_profile" type="text" id="bn_menu_ed_profile">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_ed_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_ed_message" type="text" id="en_menu_ed_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_ed_message') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_ed_message" type="text" id="bn_menu_ed_message">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_bod') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_bod" type="text" id="en_menu_bod">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_bod') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_bod" type="text" id="bn_menu_bod">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_employee') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_employee" type="text" id="en_menu_employee">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_employee') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_employee" type="text" id="bn_menu_employee">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_internet_plan') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_internet_plan" type="text" id="en_menu_internet_plan">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_internet_plan') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_internet_plan" type="text" id="bn_menu_internet_plan">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_service_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_service_title" type="text" id="en_menu_service_title">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_service_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_service_title" type="text" id="bn_menu_service_title">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_internet') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_internet" type="text" id="en_menu_internet">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_internet') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_internet" type="text" id="bn_menu_internet">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_vts') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_vts" type="text" id="en_menu_vts">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_vts') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_vts" type="text" id="bn_menu_vts">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_it') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_it" type="text" id="en_menu_it">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_it') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_it" type="text" id="bn_menu_it">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_billpay') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_billpay" type="text" id="en_menu_billpay">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_billpay') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_billpay" type="text" id="bn_menu_billpay">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_billing_system') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_billing_system" type="text" id="en_menu_billing_system">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_billing_system') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_billing_system" type="text" id="bn_menu_billing_system">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_online_pay') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_online_pay" type="text" id="en_menu_online_pay">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_online_pay') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_online_pay" type="text" id="bn_menu_online_pay">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_contact_us') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_contact_us" type="text" id="en_menu_contact_us">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_contact_us') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_contact_us" type="text" id="bn_menu_contact_us">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_more_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_more_title" type="text" id="en_menu_more_title">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_more_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_more_title" type="text" id="bn_menu_more_title">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_blog') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_blog" type="text" id="en_menu_blog">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_blog') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_blog" type="text" id="bn_menu_blog">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_notice') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_notice" type="text" id="en_menu_notice">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_notice') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_notice" type="text" id="bn_menu_notice">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_awards') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_awards" type="text" id="en_menu_awards">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_awards') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_awards" type="text" id="bn_menu_awards">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_gallery') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_gallery" type="text" id="en_menu_gallery">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_gallery') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_gallery" type="text" id="bn_menu_gallery">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_news_event') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_news_event" type="text" id="en_menu_news_event">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_news_event') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_news_event" type="text" id="bn_menu_news_event">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_circular') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_circular" type="text" id="en_menu_circular">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_circular') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_circular" type="text" id="bn_menu_circular">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_menu_admin') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_menu_admin" type="text" id="en_menu_admin">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_menu_admin') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_menu_admin" type="text" id="bn_menu_admin">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_tutorial') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_tutorial" type="text" id="en_tutorial">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_tutorial') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_tutorial" type="text" id="bn_tutorial">
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="form-group {{ $errors->has('tutorial_link') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="tutorial_link" type="text" id="tutorial_link">
