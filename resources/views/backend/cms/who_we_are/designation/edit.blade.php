...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_designation') }}" class="btn btn-sm btn-success">
                    Manage Designation
                </a>
                <form action="{{ route('admin.update_designation') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="designation_id" value="{{$designation->id}}">
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_name') ? 'has-error' : '' }}">
                                <label for="en_name" class="control-label">{{ 'EN designation Name' }}</label>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_name') ? 'has-error' : '' }}">
                                <label for="bn_name" class="control-label">{{ 'BN designation Name' }}</label>
                        ...
                        <div class="col-md-9 mt-3">
                            <div class="form-group">
                                <div class="radio inlineblock m-r-20">
                                    <input type="radio" name="status" id="publish" class="with-gap" {{ isset($designation->status) && $designation->status == 1 ? 'checked' : '' }} checked value="1">
                                    <label for="publish">Publish</label>
                                </div>
                                <div class="radio inlineblock">
                                    <input type="radio" name="status" id="unpublish" class="with-gap" {{ isset($designation->status) && $designation->status == 0 ? 'checked' : '' }} value="0">
