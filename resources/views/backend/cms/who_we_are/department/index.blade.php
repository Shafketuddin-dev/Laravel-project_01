...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.add_department') }}" class="btn btn-success btn-sm" title="Add New">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <a href="{{ route('admin.edit_department', $item->id) }}" title="Edit Department"><button class="btn btn-primary"><i class="zmdi zmdi-edit"></i>
                                            </button></a>
                                    <form action="{{ route('admin.delete_department') }}" method="post" id="delete">
                                        @csrf
