...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_skill') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Skills
                </a>
                <form action="{{ route('admin.save_skill') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_corporate_internet') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_corporate_internet" type="text" id="en_corporate_internet">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_corporate_internet') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_corporate_internet" type="text" id="bn_corporate_internet">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_corporate_internet_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_corporate_internet_percentage" type="text" id="en_corporate_internet_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_corporate_internet_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_corporate_internet_percentage" type="text" id="bn_corporate_internet_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_home_internet') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_home_internet" type="text" id="en_home_internet">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_home_internet') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_home_internet" type="text" id="bn_home_internet">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_home_internet_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_home_internet_percentage" type="text" id="en_home_internet_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_home_internet_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_home_internet_percentage" type="text" id="bn_home_internet_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_customer_support') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_customer_support" type="text" id="en_customer_support">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_customer_support') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_customer_support" type="text" id="bn_customer_support">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_customer_support_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_customer_support_percentage" type="text" id="en_customer_support_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_customer_support_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_customer_support_percentage" type="text" id="bn_customer_support_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_vts') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_vts" type="text" id="en_vts">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_vts') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_vts" type="text" id="bn_vts">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_vts_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_vts_percentage" type="text" id="en_vts_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_vts_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_vts_percentage" type="text" id="bn_vts_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_training') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_training" type="text" id="en_training">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_training') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_training" type="text" id="bn_training">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_training_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_training_percentage" type="text" id="en_training_percentage">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_training_percentage') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_training_percentage" type="text" id="bn_training_percentage">
