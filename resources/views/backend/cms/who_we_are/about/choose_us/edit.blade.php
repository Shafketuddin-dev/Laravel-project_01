...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>Home</strong>Choose Us</h2>
            ...
            <div class="body">
                <a href="{{ route('admin.manage_home_choose_us') }}" class="btn btn-sm btn-success">
                    Manage Home Choose Us
                </a>
                <form action="{{ route('admin.update_home_choose_us') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="home_choose_us_id" value="{{$home_choose_us->id}}">
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                <label for="en_title" class="control-label">{{ 'EN Title' }}</label>
                                <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($home_choose_us->en_title) ? $home_choose_us->en_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($home_choose_us->bn_title) ? $home_choose_us->bn_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control no-resize" name="en_description" id="en_description" placeholder="Please type what you want...">{{ isset($home_choose_us->en_description) ? $home_choose_us->en_description : '' }}</textarea>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control no-resize" name="bn_description" id="bn_description" placeholder="Please type what you want...">{{ isset($home_choose_us->bn_description) ? $home_choose_us->bn_description : '' }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                ...
                                <img src="{{ asset($home_choose_us->image) }}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9 mt-3">
                            <div class="form-group">
                                <div class="radio inlineblock m-r-20">
                                    <input type="radio" name="status" id="publish" class="with-gap" {{ isset($home_choose_us->status) && $home_choose_us->status == 1 ? 'checked' : '' }} checked value="1">
                                    <label for="publish">Publish</label>
                                </div>
                                <div class="radio inlineblock">
                                    <input type="radio" name="status" id="unpublish" class="with-gap" {{ isset($home_choose_us->status) && $home_choose_us->status == 0 ? 'checked' : '' }} value="0">
