                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($mission->en_title) ? $mission->en_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($mission->bn_title) ? $mission->bn_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control no-resize" name="en_description" id="en_description" placeholder="Please type what you want...">{{ isset($mission->en_description) ? $mission->en_description : '' }}</textarea>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control no-resize" name="bn_description" id="bn_description" placeholder="Please type what you want...">{{ isset($mission->bn_description) ? $mission->bn_description : '' }}</textarea>
