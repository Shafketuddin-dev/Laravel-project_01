...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>Branch</strong> Category</h2>
            ...
            <div class="body">
                <a href="{{ route('admin.manage_branch_category') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Branch Category
                </a>
                <form action="{{ route('admin.save_branch_category') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
