...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_branch') }}" class="btn btn-sm btn-success">
                    Manage Branch
                </a>
                <form action="{{ route('admin.update_branch') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="branch_id" value="{{$branch->id}}">
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <label>Branch Category</label>
                            <select name="branch_category_id" id="" class="form-control show-tick ms search-select">
                                <option value="" disabled selected>Select a Category</option>
                                @foreach ($category as $item)
                                <option value=" {{ $item->id }}" {{ isset($branch->branch_category_id) ? ($branch->branch_category_id == $item->id ? 'selected' : '') : '' }}>
                                    {{ $item->en_title }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_branch_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_branch_name" type="text" id="en_branch_name" value="{{ isset($branch->en_branch_name) ? $branch->en_branch_name : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_branch_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_branch_name" type="text" id="bn_branch_name" value="{{ isset($branch->bn_branch_name) ? $branch->bn_branch_name : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_address') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control no-resize" name="en_address" id="en_address" placeholder="Please type what you want...">{{ isset($branch->en_address) ? $branch->en_address : '' }}</textarea>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_address') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control no-resize" name="bn_address" id="bn_address" placeholder="Please type what you want...">{{ isset($branch->bn_address) ? $branch->bn_address : '' }}</textarea>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_phone') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_phone" type="text" id="en_phone" value="{{ isset($branch->en_phone) ? $branch->en_phone : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_phone') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_phone" type="text" id="bn_phone" value="{{ isset($branch->bn_phone) ? $branch->bn_phone : '' }}">
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="form-group {{ $errors->has('call_phone') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="call_phone" type="text" id="call_phone" value="{{ isset($branch->call_phone) ? $branch->call_phone : '' }}">
                        ...
                        <div class="col-md-9 mt-3">
                            <div class="form-group">
                                <div class="radio inlineblock m-r-20">
                                    <input type="radio" name="status" id="publish" class="with-gap" {{ isset($branch->status) && $branch->status == 1 ? 'checked' : '' }} checked value="1">
                                    <label for="publish">Publish</label>
                                </div>
                                <div class="radio inlineblock">
                                    <input type="radio" name="status" id="unpublish" class="with-gap" {{ isset($branch->status) && $branch->status == 0 ? 'checked' : '' }} value="0">
