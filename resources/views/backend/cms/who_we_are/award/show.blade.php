...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>Personal</strong>Award</h2>
            ...
            <div class="body">
                <a href="{{ route('admin.manage_personal_award') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Personal Award
                </a>
                <form action="{{ route('admin.save_personal_award') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control" name="en_description" placeholder="Please type what you want..."></textarea>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class="form-control" name="bn_description" placeholder="Please type what you want..."></textarea>
