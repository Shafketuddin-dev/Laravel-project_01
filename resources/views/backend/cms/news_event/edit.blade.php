...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_news_event') }}" class="btn btn-sm btn-success">
                    Manage News Event
                </a>
                <form action="{{ route('admin.update_news_event') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($news_event->en_title) ? $news_event->en_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($news_event->bn_title) ? $news_event->bn_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class=" summernote" name="en_description" placeholder="Please type what you want...">{{ isset($news_event->en_description) ? $news_event->en_description : '' }}</textarea>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_description') ? 'has-error' : '' }}">
                                ...
                                <textarea rows="4" class=" summernote" name="bn_description" placeholder="Please type what you want...">{{ isset($news_event->bn_description) ? $news_event->bn_description : '' }}</textarea>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_published_date') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_published_date" type="text" id="en_published_date" value="{{ isset($news_event->en_published_date) ? $news_event->en_published_date : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_published_date') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_published_date" type="text" id="bn_published_date" value="{{ isset($news_event->bn_published_date) ? $news_event->bn_published_date : '' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="card">
                                ...
                                <div class="body">
                                    <input type="file" name="image" class="dropify"  accept=".jpg, .png, .jpeg, .pdf, .doc, .docx">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9 mt-3">
                            <div class="form-group">
                                <div class="radio inlineblock m-r-20">
                                    <input type="radio" name="status" id="publish" class="with-gap" {{ isset($news_event->status) && $news_event->status == 1 ? 'checked' : '' }} checked value="1">
                                    <label for="publish">Publish</label>
                                </div>
                                <div class="radio inlineblock">
                                    <input type="radio" name="status" id="unpublish" class="with-gap" {{ isset($news_event->status) && $news_event->status == 0 ? 'checked' : '' }} value="0">
