...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>Youtube</strong> Video</h2>
            ...
            <div class="body">
                <a href="{{ route('admin.manage_youtube_video') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Youtube Video
                </a>
                <form action="{{ route('admin.save_youtube_video') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <div class="form-group {{ $errors->has('url') ? 'has-error' : '' }}">
                                <label for="url" class="control-label">{{ 'Youtube Video Link' }}</label>
                                <p>The Video link Should Be as: https://www.youtube.com/embed/uvleVh9Pubk, <mark>Steps</mark> 1. Go youtube 2. Play video 3. Press Share 4. Select Embeded 5. Select link from https till question mark(?) 6. Paste it to below box </p>
                                <textarea rows="4" class="form-control no-resize" name="url" id="url" placeholder="Youtube Video Link paste here..."></textarea>
