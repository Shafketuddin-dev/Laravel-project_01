...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_package_category') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Package Category
                </a>
                <form action="{{ route('admin.save_package_category') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
