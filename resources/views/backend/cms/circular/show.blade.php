...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_circular') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Circular
                </a>
                <form action="{{ route('admin.save_circular') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
