...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_image_category') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Image Category
                </a>
                <form action="{{ route('admin.save_image_category') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
