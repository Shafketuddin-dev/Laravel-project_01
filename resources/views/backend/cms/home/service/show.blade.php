...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>Home</strong> Service</h2>
            ...
            <div class="body">
                <a href="{{ route('admin.manage_home_service') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Home Service
                </a>
                <form action="{{ route('admin.save_home_service') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <div class="form-group {{ $errors->has('url') ? 'has-error' : '' }}">
                                <label for="url" class="control-label">{{ 'href URL' }}</label>
