...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>Blog</strong>Category</h2>
            ...
            <div class="body">
                <a href="{{ route('admin.manage_blog_category') }}" class="btn btn-sm btn-success">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($blog_category->en_title) ? $blog_category->en_title : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_title') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($blog_category->bn_title) ? $blog_category->bn_title : '' }}">
                        ...
                        <div class="col-md-9 mt-3">
                            <div class="form-group">
                                <div class="radio inlineblock m-r-20">
                                    <input type="radio" name="status" id="publish" class="with-gap" {{ isset($blog_category->status) && $blog_category->status == 1 ? 'checked' : '' }} checked value="1">
                                    <label for="publish">Publish</label>
                                </div>
                                <div class="radio inlineblock">
                                    <input type="radio" name="status" id="unpublish" class="with-gap" {{ isset($blog_category->status) && $blog_category->status == 0 ? 'checked' : '' }} value="0">
