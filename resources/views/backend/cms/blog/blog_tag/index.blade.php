...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.add_blog_tag') }}" class="btn btn-success btn-sm" title="Add New">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <a href="{{ route('admin.edit_blog_tag', $item->id) }}" title="Edit Blog Tag"><button class="btn btn-primary"><i class="zmdi zmdi-edit"></i>
                                            </button></a>
                                    <form action="{{ route('admin.delete_blog_tag') }}" method="post" id="delete">
                                        @csrf
                                        <input type="hidden" name="blog_tag_id" value="{{ $item->id }}">
