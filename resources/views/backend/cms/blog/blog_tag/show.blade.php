...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <a href="{{ route('admin.manage_blog_tag') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Blog Tag
                </a>
                <form action="{{ route('admin.save_blog_tag') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
