...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.add_blog') }}" class="btn btn-success btn-sm" title="Add New">
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->en_title }}</td>
                                <td>{{ $item->blogTag->en_title }}</td>
                                <td>{{ $item->blogCategory->en_title }}</td>
                                <td>{{$item->status==0? 'Unpublished':'Published'}}</td>
                                <td class="d-flex justify-content-center">
                                    <a href="{{ route('admin.edit_blog', $item->id) }}" title="Edit Blog"><button class="btn btn-primary"><i class="zmdi zmdi-edit" aria-hidden="true"></i></button></a>
                                    <form action="{{ route('admin.delete_blog') }}" method="post" id="delete">
                                        @csrf
