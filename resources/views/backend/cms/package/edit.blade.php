                ...
                <form action="{{ route('admin.update_package') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            ...
                            <select name="package_category_id" id="" class="form-control show-tick ms search-select">
                                <option value="" disabled selected>Select a Category</option>
                                @foreach ($category as $item)
                                <option value=" {{ $item->id }}" {{ isset($package->package_category_id) ? ($package->package_category_id == $item->id ? 'selected' : '') : '' }}>
                                    {{ $item->en_title }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_package_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_package_name" type="text" id="en_package_name" value="{{ isset($package->en_package_name) ? $package->en_package_name : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_package_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_package_name" type="text" id="bn_package_name" value="{{ isset($package->bn_package_name) ? $package->bn_package_name : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_mbps_value') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_mbps_value" type="text" id="en_mbps_value" value="{{ isset($package->en_mbps_value) ? $package->en_mbps_value : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_mbps_value') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_mbps_value" type="text" id="bn_mbps_value" value="{{ isset($package->bn_mbps_value) ? $package->bn_mbps_value : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_amount_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_amount_label" type="text" id="en_amount_label" value="{{ isset($package->en_amount_label) ? $package->en_amount_label : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_amount_label') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_amount_label" type="text" id="bn_amount_label" value="{{ isset($package->bn_amount_label) ? $package->bn_amount_label : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_amount') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_amount" type="text" id="en_amount" value="{{ isset($package->en_amount) ? $package->en_amount : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_amount') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_amount" type="text" id="bn_amount" value="{{ isset($package->bn_amount) ? $package->bn_amount : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_discount_monthly_fee') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_discount_monthly_fee" type="text" id="en_discount_monthly_fee" value="{{ isset($package->en_discount_monthly_fee) ? $package->en_discount_monthly_fee : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_discount_monthly_fee') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_discount_monthly_fee" type="text" id="bn_discount_monthly_fee" value="{{ isset($package->bn_discount_monthly_fee) ? $package->bn_discount_monthly_fee : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_otc_amount') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_otc_amount" type="text" id="en_otc_amount" value="{{ isset($package->en_otc_amount) ? $package->en_otc_amount : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_otc_amount') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_otc_amount" type="text" id="bn_otc_amount" value="{{ isset($package->bn_otc_amount) ? $package->bn_otc_amount : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_discount_otc') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_discount_otc" type="text" id="en_discount_otc" value="{{ isset($package->en_discount_otc) ? $package->en_discount_otc : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_discount_otc') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_discount_otc" type="text" id="bn_discount_otc" value="{{ isset($package->bn_discount_otc) ? $package->bn_discount_otc : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_one') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_one" type="text" id="en_short_info_one" value="{{ isset($package->en_short_info_one) ? $package->en_short_info_one : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_one') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_one" type="text" id="bn_short_info_one" value="{{ isset($package->bn_short_info_one) ? $package->bn_short_info_one : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_two') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_two" type="text" id="en_short_info_two" value="{{ isset($package->en_short_info_two) ? $package->en_short_info_two : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_two') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_two" type="text" id="bn_short_info_two" value="{{ isset($package->bn_short_info_two) ? $package->bn_short_info_two : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_three') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_three" type="text" id="en_short_info_three" value="{{ isset($package->en_short_info_three) ? $package->en_short_info_three : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_three') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_three" type="text" id="bn_short_info_three" value="{{ isset($package->bn_short_info_three) ? $package->bn_short_info_three : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_four') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_four" type="text" id="en_short_info_four" value="{{ isset($package->en_short_info_four) ? $package->en_short_info_four : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_four') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_four" type="text" id="bn_short_info_four" value="{{ isset($package->bn_short_info_four) ? $package->bn_short_info_four : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_five') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_five" type="text" id="en_short_info_five" value="{{ isset($package->en_short_info_five) ? $package->en_short_info_five : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_five') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_five" type="text" id="bn_short_info_five" value="{{ isset($package->bn_short_info_five) ? $package->bn_short_info_five : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_six') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_six" type="text" id="en_short_info_six" value="{{ isset($package->en_short_info_six) ? $package->en_short_info_six : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_six') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_six" type="text" id="bn_short_info_six" value="{{ isset($package->bn_short_info_six) ? $package->bn_short_info_six : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_seven') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_seven" type="text" id="en_short_info_seven" value="{{ isset($package->en_short_info_seven) ? $package->en_short_info_seven : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_seven') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_seven" type="text" id="bn_short_info_seven" value="{{ isset($package->bn_short_info_seven) ? $package->bn_short_info_seven : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_eight') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_eight" type="text" id="en_short_info_eight" value="{{ isset($package->en_short_info_eight) ? $package->en_short_info_eight : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_eight') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_eight" type="text" id="bn_short_info_eight" value="{{ isset($package->bn_short_info_eight) ? $package->bn_short_info_eight : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_nine') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_nine" type="text" id="en_short_info_nine" value="{{ isset($package->en_short_info_nine) ? $package->en_short_info_nine : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_nine') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_nine" type="text" id="bn_short_info_nine" value="{{ isset($package->bn_short_info_nine) ? $package->bn_short_info_nine : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_short_info_ten') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_short_info_ten" type="text" id="en_short_info_ten" value="{{ isset($package->en_short_info_ten) ? $package->en_short_info_ten : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_short_info_ten') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_short_info_ten" type="text" id="bn_short_info_ten" value="{{ isset($package->bn_short_info_ten) ? $package->bn_short_info_ten : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('en_button_text') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="en_button_text" type="text" id="en_button_text" value="{{ isset($package->en_button_text) ? $package->en_button_text : '' }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div class="form-group {{ $errors->has('bn_button_text') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" name="bn_button_text" type="text" id="bn_button_text" value="{{ isset($package->bn_button_text) ? $package->bn_button_text : '' }}">
